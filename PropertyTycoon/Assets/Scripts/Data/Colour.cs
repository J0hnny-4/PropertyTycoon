namespace Data
{
    public class Colour
    {
        public static readonly Colour Brown = new Colour("Brown", new UnityEngine.Color(0.5f, 0.25f, 0f));
        ...
        public static readonly Colour Orange = new Colour("Orange", new UnityEngine.Color(1f, 0.5f, 0f));
